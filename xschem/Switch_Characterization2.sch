...
N 550 -340 610 -340 { lab=VL}
N 470 -340 470 -320 { lab=GND}
N 370 -340 440 -340 { lab=#net3}
N 500 -340 550 -340 { lab=VL}
N 470 -490 470 -380 { lab=Vg}
N 340 -490 470 -490 { lab=Vg}
...
C {devices/lab_wire.sym} 580 -340 0 0 {name=l4 sig_type=std_logic lab=VL
}
C {devices/res.sym} 610 -250 0 0 {name=R2
value=50
footprint=1206
device=resistor
m=1}
C {devices/gnd.sym} 610 -220 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} 610 -310 0 0 {name=V2 value=0}
C {devices/vsource.sym} 280 -490 1 0 {name=V3 value=1.8
}
...
C {devices/vsource.sym} 150 -180 1 0 {name=V4 value=0}
...
C {xschem_sky130/sky130_fd_pr/nfet_01v8_lvt.sym} 470 -360 3 1 {name=M2
L=0.15
W=6
nf=1
mult=25
...
C {devices/gnd.sym} 470 -320 0 0 {name=l11 lab=GND}
